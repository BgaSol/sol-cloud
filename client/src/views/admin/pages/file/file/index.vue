...
import {dayjs, ElButton, ElForm, ElFormItem, ElInput, ElPagination, ElTable, ElTableColumn,} from 'element-plus';
...
const getTable = async () => {
  ...
  return Service.findByPageFileController(true, requestData.value)
      .then((res) => {
...
<template>
  <div class="main">
    ...
    <div class="controllers">
      ...
      <base-batch-delete
          v-if="tableRef"
          :api="Service.deleteFileController"
          :table="tableRef"
          @success="getTable"
      ></base-batch-delete>
    </div>
